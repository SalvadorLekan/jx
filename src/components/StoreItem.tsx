...
function StoreItem({
  ...
  return (
    <Link
      className="shop-card col-12 col-md-6 col-lg-4 py-2"
      to={"/shop/" + slug + "/product/" + item.productSlug}
    >
      <div className="rounded d-grid">
        <div className="card-img d-flex justify-content-center align-items-center">
          {item.productMedia.length ? (
            <img src={item.productMedia[0]} alt="bb" />
          ) : (
            <svg
              id="Capa_1"
        ...
        <div className="card-details rounded-bottom p-3">
          <div className="d-flex justify-content-between align-items-center">
            ...
            <div onClick={(e) => e.stopPropagation()} className="add-to-cart">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
